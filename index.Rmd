...
Chapters 1 and 2 will cover downloading and describing R and the RStudio IDE, and programming basics, such as variable types and data types, objects and assignments, and functions and arguments. Chapters 3 and 4 will cover installing/loading packages and reading/writing data. Chapters 5 and 6 will cover formatting data, descriptive statistics, and visualizing data. Chapters 7-13 will cover various statistical models from the General Linear Model (GLM) framework. In the simplest form, GLM is described as: DATA = MODEL + ERROR.  
