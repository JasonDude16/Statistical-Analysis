...
>
>You might want to type code directly into the console when you're performing calculations but you don't care about saving the results. A script is like a notepad where you can save your analysis. If you needed to calculate `75 * 82`, it's probably not essential to have that calculation saved to your notebad, so you can type it directly into the console to keep your notepad clean. That way, you won't have to constantly delete irrelevant code and calculations from your script.
