...
There are two folders shown in the example image above. If you're following along with the folder we created for this book, which you can download [here](https://github.com/JasonDude16/Statistical-Analysis-Folder), then your folder setup should look the same. 
