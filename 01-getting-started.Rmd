...
>This chapter will walk through the steps of getting started with R and RStudio. <span style="background-color:lightyellow"><b>At the end of the chapter, we'll provide a link where you can download a folder that includes all of the code and data that's used in this guidebook.</b></span>
